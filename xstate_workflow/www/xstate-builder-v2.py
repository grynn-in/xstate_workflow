...
"""
Web Page controller for Workflow Builder V2
"""
...
def get_context(context):
	"""
	Context for workflow-builder-v2 page.
	"""
	...
	context.title = _("Workflow Builder V2")
	...
	context.include_css = [
		...
		f"/assets/xstate_workflow/js/workflow_builder.v2.css?v={cache_bust}"
	]
